                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-md-4 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 m-0">
                            ...
                            <!-- end alet section-->
                            @include("auth.alert.errors")
                            @include("auth.alert.success")

                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" action="{{route('loginPost')}}" method="post"
                                          novalidate>
                                ...
                                <p class="text-center">
                                    <a href="register{{request('redirect_url') ? '?redirect_url='.request('redirect_url') : ''}}" class="text-center">Register</a>
                                </p>
